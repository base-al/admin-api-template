...
func (m *Module) seedDefaultSettings() error {
	defaultSettings := []Settings{
		...
		// Media Settings
		{
			SettingKey:  "media_convert_images",
			Label:       "Convert Images to WebP",
			Group:       "media",
			Type:        "bool",
			ValueBool:   true,
			Description: "Automatically convert uploaded images to WebP format",
			IsPublic:    false,
		},
		{
			SettingKey:  "media_convert_videos",
			Label:       "Convert Videos to WebM",
			Group:       "media",
			Type:        "bool",
			ValueBool:   true,
			Description: "Automatically convert uploaded videos to WebM format (VP9 + Opus)",
			IsPublic:    false,
		},
		{
			SettingKey:  "media_convert_audio",
			Label:       "Convert Audio to Opus",
			Group:       "media",
			Type:        "bool",
			ValueBool:   true,
			Description: "Automatically convert uploaded audio files to Opus format",
			IsPublic:    false,
		},
		{
			SettingKey:  "media_keep_original",
			Label:       "Keep Original Files",
			Group:       "media",
			Type:        "bool",
			ValueBool:   false,
			Description: "Keep original files after conversion (stores both versions)",
			IsPublic:    false,
		},
		{
			SettingKey:  "media_image_quality",
			Label:       "Image Quality",
			Group:       "media",
			Type:        "int",
			ValueInt:    85,
			Description: "WebP image quality (0-100, recommended 80-90)",
			IsPublic:    false,
		},
		{
			SettingKey:  "media_video_quality",
			Label:       "Video Quality (CRF)",
			Group:       "media",
			Type:        "int",
			ValueInt:    23,
			Description: "Video quality CRF value (0-51, lower is better, recommended 23-28)",
			IsPublic:    false,
		},
		{
			SettingKey:  "media_audio_bitrate",
